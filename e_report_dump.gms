...
$call 'gdxdump %gdxFileName% format=csv epsout=0 symb=cap_new_icrt_refurb > %outputsPath%cap_new_icrt_refurb.csv'
...
$call 'gdxdump %gdxFileName% format=csv epsout=0 symb=RE_cap_price_r > %outputsPath%RE_cap_price_r.csv'
...
$call 'gdxdump %gdxFileName% format=csv epsout=0 symb=vre_cost_vom > %outputsPath%vre_cost_vom.csv'
...
$call 'gdxdump %gdxFileName% format=csv epsout=0 symb=rsc_copy > %outputsPath%rsc_copy.csv'
