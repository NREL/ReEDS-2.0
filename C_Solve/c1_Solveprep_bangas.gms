...
set ban(i) "ban from existing, prescribed, and new generation -- usually indicative of missing data or operational constraints"
    ...
    bangasrb(i,rb) "ban new gas buildouts from UP BAs"
    bangasr(i,r)
;
...
bangasrb("CCGT-GAS", "UP_Agra") = yes;
bangasrb("CCGT-Gas", "UP_Meerut") = yes;
bangasrb("CCGT-Gas", "UP_Lucknow") = yes;
bangasrb("CCGT-Gas", "UP_Varanasi") = yes;
bangasrb("CCGT-Gas", "UP_Kanpur") = yes;
bangasrb("CT-GAS", "UP_Agra") = yes;
bangasrb("CT-GAS", "UP_Meerut") = yes;
bangasrb("CT-GAS", "UP_Lucknow") = yes;
bangasrb("CT-GAS", "UP_Varanasi") = yes;
bangasrb("CT-GAS", "UP_Kanpur") = yes;

bangasr("CCGT-GAS", "UP_Agra") = yes;
bangasr("CCGT-Gas", "UP_Meerut") = yes;
bangasr("CCGT-Gas", "UP_Lucknow") = yes;
bangasr("CCGT-Gas", "UP_Varanasi") = yes;
bangasr("CCGT-Gas", "UP_Kanpur") = yes;
bangasr("CT-GAS", "UP_Agra") = yes;
bangasr("CT-GAS", "UP_Meerut") = yes;
bangasr("CT-GAS", "UP_Lucknow") = yes;
bangasr("CT-GAS", "UP_Varanasi") = yes;
bangasr("CT-GAS", "UP_Kanpur") = yes;
...
valcap(i,newv,rb,t)$[rfeas(rb)$(not rsc_i(i))$tmodel_new(t)$(not ban(i))$(not bannew(i))$(not bangasrb(i,rb))
...
valcap(i,newv,r,t)$[rfeas_cap(r)$rsc_i(i)$tmodel_new(t)$(not ban(i))$(not bannew(i))$(not bangasr(i,r))
...
valcap_irt(i,r,t)$(not bangasr(i,r)) = sum{v, valcap(i,v,r,t)};
