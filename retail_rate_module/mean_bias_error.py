...
to ReEDS-2.0/retail_rate_module/inputs/state-meanbiaserror_rate-aggregation.csv.
...
retailmodulepath = os.path.join(reeds_dir,'retail_rate_module','')
inputs_default_path = retailmodulepath+'inputs_default.csv'

inflation = pd.read_csv(
    os.path.join(reeds_dir,'inputs','inflation','inflation_default.csv'),
    index_col=['t'])
