...
inflatable = ferc_distadmin.get_inflatable(
    inflationpath=os.path.join('..','..','inputs','inflation','inflation_default.csv'))
### Format as dataframe
...
rsc_dat = rsc_dat.rename(columns={
    'Dim1':'r', 'Dim2':'s', 'Dim3':'i', 'Dim4':'bin', 'Dim5':'dat_type', 'Val':'dat_value'})
