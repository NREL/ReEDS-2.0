...
outage_forced = pd.read_csv(os.path.join(inputs_case,'outage_forced.csv'),
...
can_imports_szn_frac = pd.read_csv(os.path.join(inputs_case,'can_imports_szn_frac.csv'),
