...
RAMPUP_STORAGE.lo(i,r,h,hh,t_unfix)$[storage_hybrid(i)$(not csp(i))$Sw_StartCost$startcost(i)$numhours_nexth(h,hh)$valgen_irt(i,r,t_unfix)] = 0 ;
RAMPUP_STORAGE.up(i,r,h,hh,t_unfix)$[storage_hybrid(i)$(not csp(i))$Sw_StartCost$startcost(i)$numhours_nexth(h,hh)$valgen_irt(i,r,t_unfix)] = +inf ;
