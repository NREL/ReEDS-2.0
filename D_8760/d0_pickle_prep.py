...
if __name__ == '__main__':
    ...
    load_profiles = pd.read_pickle(os.path.join(path_static,'{}_load.pkl'.format(static_inputs)))
    recf = pd.read_pickle(os.path.join(path_static,'{}_recf.pkl'.format(static_inputs)))
    resources = pd.read_pickle(os.path.join(path_static,'{}_resources.pkl'.format(static_inputs)))
