...
fuel_price_filt(i,r)$[Sw_H2$re_ct(i)$(sum{t$tcur(t),yeart(t) } >= Sw_H2_Demand_Start)$cap_exist_ir(i,r)] =
            sum{t$tcur(t),
...
routes_filt(r,rr,"AC") = sum{(trtype,t)$[tcur(t)$notvsc(trtype)], routes(r,rr,trtype,t) } ;
routes_filt(r,rr,"VSC") = sum{t$tcur(t), routes(r,rr,"VSC",t) } ;
...
energy_price(r,h) = sum{t$tcur(t), (1 / cost_scale) * (1 / pvf_onm(t)) * eq_supply_demand_balance.m(r,h,t) / hours(h) } ;
