...
2. If differences are desired, set 'diff' to 'Yes' and set 'base' to the name of the base case (below).
3. If a different report is desired (other than standard_report_reduced), update 'report_path' (below).
...
diff = 'No' #Use 'Yes' if adding differences to a base case, specified below.
base = 'Ref' #Name of base case, if applicable. If base case is not needed for this report, simply leave as is.
