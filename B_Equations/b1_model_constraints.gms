...
eq_prescribedre_pre2023(i,r,t)$[rfeas(r)$tmodel(t)$required_prescriptions(i,r,t)$(yeart(t) < 2024)
...
eq_forceprescription(i,r,t)$[tmodel(t)$required_prescriptions(i,r,t)$(yeart(t) > 2023)
                                $prescriptivetech(i)$Sw_Prescribed]..
...
*capacity built in the current period or prior
  ...
  + sum{(v,tt)$[ivt(i,v,tt)$(tmodel(tt) or tfix(tt))$(yeart(tt)<=yeart(t))$(yeart(t)-yeart(tt)<maxage(i))],
        INVREFURB(i,v,r,tt) }$[refurbtech(i)$Sw_Refurb]
