...
eer_scenario = '20220819_reeds_load_central'
input_file_dir = r'//nrelnas01/ReEDS/FY22-Bespoke/NTPS/EER_Load/20220819_all_scenarios'
...
for weather_year in weather_years:
    ...
    for f in eer_files:
        f_years = f.replace(eer_scenario + '_','').replace('_total_loads.csv','')
