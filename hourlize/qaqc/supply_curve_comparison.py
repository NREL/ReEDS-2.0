...
supply_curves = [
    {'name': 'reference', 'path': r"\\nrelnas01\ReEDS\Supply_Curve_Data\ONSHORE\2024_06_20_Update\wind-ons_reference_ba\results\wind-ons_supply_curve_raw.csv"},
    {'name': 'limited', 'path': r"\\nrelnas01\ReEDS\Supply_Curve_Data\ONSHORE\2024_06_20_Update\wind-ons_limited_ba\results\wind-ons_supply_curve_raw.csv"},
]
