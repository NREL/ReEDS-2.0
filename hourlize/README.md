...
1. `save_time_outputs()`
    - Weighted average profiles by region/class are saved to a `{tech}.h5` file. This method makes use of the same h5 format specified in the `write_h5_file` function used by `ldc_prep.py` in ReEDS.
1. `map_supplycurve()`
