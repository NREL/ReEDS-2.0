...
def save_time_outputs(df_prof_out, df_rep, outpath, tech,
    ...
    if 'csv' in filetype:
        ...
        write_h5_file(df_hr, f'{tech}.h5', os.path.join(outpath, 'results'), compression_opts=compression_opts)
...
if __name__== '__main__':
    ...
    site.addsitedir(os.path.join(cf.reeds_path))
    from preprocessing import geo_supply_curve_aggregation
    from input_processing.ldc_prep import write_h5_file
