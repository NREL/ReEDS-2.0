...
| PSH capital cost | Declines over time per Hydropower Vision {cite}`doeHydropowerVisionNew2016` | Declines over time per Hydropower Vision {cite}`doeHydropowerVisionNew2016` |
