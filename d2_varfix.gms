...
* generation and storage variables
    ...
    RAMPUP_PLANT.fx(i,r,h,hh,tfix)$[storage_hybrid(i)$(not csp(i))$Sw_StartCost$startcost(i)$numhours_nexth(h,hh)$valgen_irt(i,r,tfix)] = RAMPUP_PLANT.l(i,r,h,hh,tfix) ;
