...
# gdxfiles = c("HAV update" = "output_Nov3HAVup_Reference.gdx")
#              "Regional Opres" = "output_TestRegOpres_Reference.gdx")

#gdxfiles = c("Reference" = "output_Oct29_Reference.gdx")
#               "No ES Op Reserves" = "output_Oct29_NoStorOpres.gdx",
#               "No ES Capacity Credit" = "output_Oct29_NoStorCC.gdx",
#              "No ES Arbitrage Value" = "output_Oct29_NoStorHAV.gdx")

# gdxfiles = c("Reference" = "output_Nov9_Reference.gdx",
#               "Low Bat Cost" = "output_Nov9_LowBatCost.gdx",
#               "High Bat Cost" = "output_Nov9_HighBatCost.gdx",
#              "Lower Peak" = "output_Nov9_LowerPeak.gdx",
#              "No South Asia" = "output_Nov9_NoSouthAsia.gdx")
...
p = plot_timeslice_generation(aggregate.by = "state", year = select_year, type = 'capacity',
                              state_filter = select_state, scenario_filter = scenario.names[1])
...
# Generation by year, state
p = plot_timeslice_generation(aggregate.by = "state", year = select_year, type = 'capacity',
                              state_filter = other_states, scenario_filter = scenario.names[1])
